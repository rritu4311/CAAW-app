<x-app-layout>
 ...
 class="text-blue-600 dark:text-blue-400 hover:text-blue-800 :text-blue-300">
 ...
 <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100 ">No archived projects</h3>
 ...
 <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900 text-red-800 ">
 Archived
 </span>
 </div>
