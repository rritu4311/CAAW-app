<x-app-layout>
 ...
 <!-- Single Invite Form -->
 <form action="{{ route('workspaces.invite', $workspace) }}" method="POST" id="singleInviteForm">
 @csrf
 ...
 <!-- Bulk Invite Form -->
 <form action="{{ route('workspaces.bulk-invite', $workspace) }}" method="POST" id="bulkInviteForm" class="hidden mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 " enctype="multipart/form-data">
 @csrf
 <div class="mb-4">
 ...
 CSV format: email,role (role column is optional). Example: user@example.com,user
 </p>
 </div>
 ...
 class="text-xs px-2 py-1 border border-gray-300 dark:border-gray-600 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent ">
