...
<div class="py-12">
 ...
 <a href="{{ route('folder-manager') }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800">
 Home
 </a>
 @foreach($breadcrumb as $index => $crumb)
 <span class="text-gray-400 dark:text-gray-400">/</span>
 @if($index < count($breadcrumb) - 1)
 <a href="{{ route('folder-manager', ['folder' => $crumb['path']]) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800">
 {{ $crumb['name'] }}
 </a>
 @else
 ...
 <!-- Error Messages -->
 @if($errors->any())
 <div class="bg-red-100 dark:bg-red-900 border border-red-400 text-red-700 px-4 py-3 rounded mb-6">
 <ul>
 ...
 <!-- Upload Area -->
 <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 sm:p-6 lg:p-8 text-center hover:border-blue-500 :border-blue-400 transition-all duration-300 mb-6 relative overflow-hidden" id="dropZone">
 <!-- Upload Progress -->
 ...
 <svg class="mx-auto h-16 w-16 text-gray-400 dark:text-gray-400 mb-4 transition-transform duration-300 hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
 </svg>
 <p class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Upload files to this folder</p>
 ...
 <p class="text-xs text-gray-500 dark:text-gray-500 mt-2">Max file size: 50MB (images/docs), 500MB (videos)</p>
 </div>
 </form>
 </div>
 ...
 class="flex items-center p-3 bg-blue-50 /30 rounded-lg hover:bg-blue-100 dark:bg-blue-900 :bg-blue-900/50 transition-colors border border-blue-200 ">
 ...
 <p class="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate">{{ $folder['name'] }}</p>
 <p class="text-xs text-gray-500 dark:text-gray-500 ">Folder</p>
 </div>
 ...
 <div class="flex-shrink-0 w-10 h-10 mr-4">
 @if($file['is_image'])
 <div class="w-10 h-10 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-900">
 ...
 <svg class="w-5 h-5 text-gray-500 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20">
 <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd"/>
 </svg>
 </div>
 @endif
 ...
 <p class="text-xs text-gray-500 dark:text-gray-500 ">{{ $file['formatted_size'] }}</p>
 </div>
 ...
 <p class="text-gray-500 dark:text-gray-500 ">No files in this folder</p>
 <p class="text-sm text-gray-400 dark:text-gray-400 mt-1">Upload some files to get started</p>
 </div>
 @endif
