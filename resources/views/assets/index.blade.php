                ...
                <div class="p-6">
                    @if($assets->count() > 0)
                        <div class="space-y-3">
                            @foreach($assets as $asset)
                                <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-900 border rounded-lg hover:shadow-md transition-shadow">
                                    <!-- Icon/Thumbnail -->
                                    ...
                                    <div class="flex-1 min-w-0 mr-4">
                                        <h4 class="text-sm font-semibold text-gray-800 dark:text-white truncate" title="{{ $asset->name }}">{{ $asset->name }}</h4>
                                    ...
                                    <div class="flex items-center gap-2 flex-shrink-0">
                                        ...
                                        <a href="{{ Storage::url($asset->file_path) }}" download="{{ $asset->name }}" 
                                            class="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-white text-xs font-medium rounded transition-colors">Download</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">No Assets Found</h3>
