<section>
 ...
 <select id="email_notification_preference" name="email_notification_preference" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
 ...
 <input type="checkbox" id="in_app_notifications" name="in_app_notifications" value="1" {{ old('in_app_notifications', $user->in_app_notifications) ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
