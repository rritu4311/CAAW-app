<x-app-layout>
 ...
 @endphp
 <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer" onclick="window.location='{{ route('projects.show', $project) }}'">
 ...
 ($userRole === 'reviewer' ? 'bg-green-100 dark:bg-green-900 text-green-800 ' :
