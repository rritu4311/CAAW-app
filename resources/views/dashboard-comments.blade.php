    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Recent Comments</h1>
                    
                    @if($newComments->count() > 0)
                        <div class="space-y-4">
                            @foreach($newComments as $comment)
                                @if($comment->asset)
                                    <a href="{{ route('assets.show', $comment->asset) }}" class="block p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors cursor-pointer">
                                @else
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500 dark:text-gray-400">When people comment on assets, they'll appear here.</p>
                        </div>
                    @endif
                </div>
            </div>
