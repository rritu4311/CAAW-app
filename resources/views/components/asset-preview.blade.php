<div id="assetPreviewModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
 ...
 <p id="previewMeta" class="text-sm text-gray-500 dark:text-gray-500 "></p>
 </div>
 </div>
 <button onclick="closeAssetPreview()" 
 class="text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:text-gray-400 :text-gray-300 transition-colors">
...
function getImagePreview() {
 ...
 <div>
 <h3 class="font-semibold text-gray-900 dark:text-gray-100 ">Image Preview</h3>
 <p class="text-sm text-gray-500 dark:text-gray-500 ">${new Date().toLocaleTimeString()}</p>
 </div>
 </div>
 <button onclick="closeAssetPreview()" class="text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:text-gray-400 :text-gray-300 transition-colors">
 <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
 </svg>
 </button>
 ...
 <!-- Canvas Container -->
 <div class="relative bg-gray-50 dark:bg-gray-700 " style="height: 700px;">
 ...
 <!-- Loading State -->
 <div id="canvasLoading" class="absolute inset-0 flex items-center justify-center bg-gray-50 dark:bg-gray-700 ">
 ...
 <!-- Test Canvas Button -->
 <button onclick="testCanvas()" class="bg-white dark:bg-gray-800/95 /95 backdrop-blur-sm rounded-lg shadow-lg p-2 hover:bg-gray-100 dark:bg-gray-900 :bg-gray-700 transition-colors" title="Test Canvas">
 ...
 <!-- Zoom Controls -->
 <div class="bg-white dark:bg-gray-800/95 /95 backdrop-blur-sm rounded-lg shadow-lg p-1 flex flex-col space-y-1">
 <button onclick="zoomIn()" class="p-2 hover:bg-gray-100 dark:bg-gray-900 :bg-gray-700 rounded transition-colors" title="Zoom In">
 <svg class="w-4 h-4 text-gray-700 dark:text-gray-300 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v6m3-3H7"></path>
 </svg>
 </button>
 <button onclick="zoomOut()" class="p-2 hover:bg-gray-100 dark:bg-gray-900 :bg-gray-700 rounded transition-colors" title="Zoom Out">
 <svg class="w-4 h-4 text-gray-700 dark:text-gray-300 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM13 10H7"></path>
 </svg>
 </button>
 <button onclick="resetZoom()" class="p-2 hover:bg-gray-100 dark:bg-gray-900 :bg-gray-700 rounded transition-colors" title="Reset Zoom">
 <svg class="w-4 h-4 text-gray-700 dark:text-gray-300 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <!-- Content Section -->
 <div class="p-4">
 <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">${currentAsset.name}</h3>
 ...
 <button class="flex items-center space-x-2 text-gray-500 dark:text-gray-500 hover:text-red-500 transition-colors group">
 <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
 </svg>
 <span class="text-sm font-medium">Like</span>
 </button>
 <button class="flex items-center space-x-2 text-gray-500 dark:text-gray-500 hover:text-blue-500 transition-colors group">
 <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
 </svg>
 <span class="text-sm font-medium">Comment</span>
 </button>
 <button class="flex items-center space-x-2 text-gray-500 dark:text-gray-500 hover:text-green-500 transition-colors group">
 <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button class="text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 :text-gray-300 transition-colors">
...
function getVideoPreview() {
 ...
 <button onclick="downloadAsset()" class="bg-white dark:bg-gray-800 rounded-lg p-2 shadow-lg hover:bg-gray-100 dark:bg-gray-900 :bg-gray-700 transition-colors" title="Download">
 ...
 <span class="ml-2 text-gray-900 dark:text-gray-100 font-medium" data-video-duration>
 ${currentAsset.duration || 'Loading...'}
 </span>
 </div>
 <div>
 <span class="text-gray-600 dark:text-gray-400 ">Resolution:</span> 
 <span class="ml-2 text-gray-900 dark:text-gray-100 font-medium" data-video-resolution>
 ${currentAsset.resolution || 'Loading...'}
 </span>
 </div>
 <div>
 <span class="text-gray-600 dark:text-gray-400 ">File Size:</span> 
 <span class="ml-2 text-gray-900 dark:text-gray-100 font-medium">${currentAsset.size}</span>
 </div>
 <div>
 <span class="text-gray-600 dark:text-gray-400 ">Format:</span> 
 <span class="ml-2 text-gray-900 dark:text-gray-100 font-medium">${currentAsset.mime_type}</span>
 </div>
 </div>
 ...
 <span class="text-gray-500 dark:text-gray-500 ">Quality</span>
 <span class="px-2 py-1 bg-blue-100 dark:bg-blue-900 /30 text-blue-700 rounded-full text-xs font-medium">
 ...
 <div class="flex items-center justify-between text-xs">
 <span class="text-gray-500 dark:text-gray-500 ">Playback Speed</span>
 <select id="playbackSpeed" onchange="changePlaybackSpeed(this.value)" class="px-2 py-1 bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 rounded text-xs">
...
function getPdfPreview() {
 ...
 <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100 ">PDF Viewer</h4>
 <div class="flex items-center space-x-2">
 <button onclick="downloadPdf()" class="text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 :text-gray-300" title="Download PDF">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
 </svg>
 </button>
 <button onclick="collapsePdfViewer()" class="text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 :text-gray-300" title="Close">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
 </svg>
 </button>
 ...
 <div><span class="text-gray-600 dark:text-gray-400 ">File Size:</span> <span class="ml-2 text-gray-900 dark:text-gray-100 ">${currentAsset.size}</span></div>
 <div><span class="text-gray-600 dark:text-gray-400 ">Type:</span> <span class="ml-2 text-gray-900 dark:text-gray-100 ">${currentAsset.mime_type}</span></div>
 <div><span class="text-gray-600 dark:text-gray-400 ">Modified:</span> <span class="ml-2 text-gray-900 dark:text-gray-100 ">${new Date(currentAsset.updated_at).toLocaleDateString()}</span></div>
 <div><span class="text-gray-600 dark:text-gray-400 ">Pages:</span> <span class="ml-2 text-gray-900 dark:text-gray-100 ">Unknown</span></div>
 </div>
...
function getDocumentPreview() {
 ...
 <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">${currentAsset.name}</h3>
 <p class="text-gray-500 dark:text-gray-500 mb-6">${currentAsset.size} • ${currentAsset.mime_type}</p>
 
 <!-- Document Information Panel -->
 <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 text-left max-w-md mx-auto">
 <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Document Details</h4>
 <div class="space-y-2 text-sm">
 <div class="flex justify-between">
 <span class="text-gray-600 dark:text-gray-400 ">Type:</span>
 <span class="text-gray-900 dark:text-gray-100 font-medium">${currentAsset.mime_type}</span>
 </div>
 <div class="flex justify-between">
 <span class="text-gray-600 dark:text-gray-400 ">Size:</span>
 <span class="text-gray-900 dark:text-gray-100 font-medium">${currentAsset.size}</span>
 </div>
 <div class="flex justify-between">
 <span class="text-gray-600 dark:text-gray-400 ">Modified:</span>
 <span class="text-gray-900 dark:text-gray-100 font-medium">${new Date(currentAsset.updated_at).toLocaleDateString()}</span>
 </div>
 </div>
 </div>
...
function getGenericPreview() {
 ...
 <svg class="w-16 h-16 text-gray-400 dark:text-gray-400 " fill="currentColor" viewBox="0 0 20 20">
...
function getIconConfig(type) {
 ...
 hoverBg: 'hover:bg-purple-200 :bg-purple-900/50'
 },
 generic: { 
 path: 'M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z', 
 color: 'text-gray-500 dark:text-gray-500', 
 bg: 'bg-gray-100 dark:bg-gray-900 ',
 hoverColor: 'hover:text-gray-600 dark:text-gray-400',
 hoverBg: 'hover:bg-gray-200 :bg-gray-600'
 }
 };
