    ...
    <div class="p-6">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center mb-2">
                <h4 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Progress</h4>
        ...
        <div class="grid grid-cols-3 gap-4 mb-6">
            ...
            <div class="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ rand(1, 7) }}</div>
        ...
        <!-- Team Members (Mock) -->
        <div class="mb-6">
            <h4 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">Team Members</h4>
            <div class="flex -space-x-2">
                @for($i = 1; $i <= rand(2, 4); $i++)
                    <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 border-2 border-white dark:border-gray-800 flex items-center justify-center text-white text-xs font-semibold">
                        {{ strtoupper(chr(64 + $i)) }}
                    </div>
                @endfor
                <div class="w-8 h-8 rounded-full bg-gray-300 dark:bg-gray-600 border-2 border-white dark:border-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-300 text-xs font-semibold">
                    +{{ rand(1, 3) }}
                </div>
            </div>
        </div>
