...
<div id="editFolderModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
 ...
 <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Edit Folder</h3>
 <button onclick="closeModal('editFolderModal')" class="text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:text-gray-400">
 ...
 <div class="mb-4">
 <label for="editFolderName" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 Folder Name
 </label>
 <input type="text" 
 id="editFolderName" 
