...
<div x-data="{ 
 ...
 <p class="text-gray-400 dark:text-gray-400 text-xs" x-text="fileSize ? fileSize + ' • ' + fileType.toUpperCase() : fileType.toUpperCase()"></p>
 </div>
 </div>
 </div>
 ...
 <button @click="prevFile()" class="p-2 text-gray-400 dark:text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
 </svg>
 </button>
 <span class="text-gray-400 dark:text-gray-400 text-sm" x-text="(currentIndex + 1) + ' / ' + (assets ? assets.length : 0)"></span>
 <button @click="nextFile()" class="p-2 text-gray-400 dark:text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 :class="showInfo ? 'bg-blue-600 text-white' : 'text-gray-400 dark:text-gray-400 hover:text-white hover:bg-gray-800'"
 ...
 <!-- Download -->
 <a :href="fileSrc" download x-show="fileSrc" class="p-2 text-gray-400 dark:text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <!-- Close -->
 <button @click="closeFile()" class="p-2 text-gray-400 dark:text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <span class="text-gray-400 dark:text-gray-400 text-sm">Loading...</span>
 </div>
 </div>
 ...
 <div class="flex items-center gap-2">
 <a :href="fileSrc" download class="p-2 text-gray-400 dark:text-gray-400 hover:text-white hover:bg-gray-700 rounded transition-colors" title="Download PDF">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
 </svg>
 </a>
 <a :href="fileSrc" target="_blank" class="p-2 text-gray-400 dark:text-gray-400 hover:text-white hover:bg-gray-700 rounded transition-colors" title="Open in new tab">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div class="w-full h-full max-w-6xl bg-white dark:bg-gray-800 rounded-lg shadow-2xl overflow-hidden flex items-center justify-center">
 ...
 <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2" x-text="fileName"></h3>
 ...
 {{-- Text Files --}}
 <template x-if="['txt', 'md', 'markdown'].includes(fileType)">
 <div class="w-full h-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-2xl overflow-hidden flex flex-col">
 <div class="flex items-center justify-between px-4 py-2 bg-gray-50 dark:bg-gray-700 border-b">
 <span class="text-sm text-gray-500 dark:text-gray-500" x-text="fileName"></span>
 <span class="text-xs text-gray-400 dark:text-gray-400 uppercase" x-text="fileType"></span>
 </div>
 <iframe :src="fileSrc" @load="onIframeLoad()" class="flex-1 w-full border-0 bg-white dark:bg-gray-800"></iframe>
 </div>
 </template>
 ...
 <div class="w-24 h-24 bg-gray-100 dark:bg-gray-900 rounded-2xl flex items-center justify-center mx-auto mb-6">
 ...
 <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2" x-text="fileName || 'Unknown File'"></h3>
 ...
 <div x-show="fileName">
 <label class="text-gray-400 dark:text-gray-400 text-xs uppercase tracking-wider">Name</label>
 <p class="text-black text-sm truncate" x-text="fileName"></p>
 </div>
 
 <div x-show="fileSize">
 <label class="text-gray-400 dark:text-gray-400 text-xs uppercase tracking-wider">Size</label>
 <p class="text-black text-sm" x-text="fileSize"></p>
 </div>
 
 <div x-show="fileType">
 <label class="text-gray-400 dark:text-gray-400 text-xs uppercase tracking-wider">Type</label>
 <p class="text-black text-sm uppercase" x-text="fileType"></p>
 </div>
 
 <template x-if="fileType === 'video' && videoDuration">
 <div>
 <label class="text-gray-400 dark:text-gray-400 text-xs uppercase tracking-wider">Duration</label>
 ...
 <div>
 <label class="text-gray-400 dark:text-gray-400 text-xs uppercase tracking-wider">Resolution</label>
 <p class="text-black text-sm flex items-center gap-2">
 <svg class="w-4 h-4 text-gray-400 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div class="hidden sm:flex items-center gap-2 ml-4 text-gray-400 dark:text-gray-400 text-xs">
