<x-app-layout>
 ...
 <form action="{{ route('workspace.update', [$workspace, $project]) }}" method="POST">
 @csrf
 @method('PUT')
 ...
 class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $project->description) }}</textarea>
 </div>
