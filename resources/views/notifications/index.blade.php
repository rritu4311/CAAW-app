<x-app-layout>
 ...
 <!-- Header Section -->
 <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 ">
 ...
 <div class="mb-4 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden transition-all duration-200 hover:shadow-md {{ is_null($notification->read_at) ? 'bg-blue-50 /20 border-blue-200 ' : 'bg-white dark:bg-gray-800 ' }}">
 ...
 <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 ">
 New
 </span>
 @endif
 ...
 <div class="mb-3">
 <p class="text-base font-medium text-gray-900 dark:text-gray-100 leading-relaxed">
 ...
 {{-- Show accept/decline for invited users or status if action taken --}}
 @if(!is_null($notification->approve_at))
 <div class="flex items-center space-x-2">
 <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 ">
 ...
 <div class="flex items-center space-x-2">
 <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900 text-red-800 ">
 <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
 <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path>
 </svg>
 Declined
 ...
 @elseif(in_array($notification->data['type'] ?? '', ['workspace_invitation_response', 'project_invitation_response']))
 {{-- Show status for invitation response notifications --}}
 @if($notification->data['status'] === 'accepted' || $notification->data['status'] === 'approved')
 <div class="flex items-center space-x-2">
 <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 ">
 <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
 <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
 ...
 @elseif($notification->data['status'] === 'rejected' || $notification->data['status'] === 'declined')
 <div class="flex items-center space-x-2">
 <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900 text-red-800 ">
 <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
 <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path>
 ...
 <span class="text-sm text-gray-500 dark:text-gray-500 ">No actions available</span>
 @endif
 </div>
 ...
 @csrf
 @method('PATCH')
 <button class="inline-flex items-center text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 :text-blue-300 font-medium transition-colors">
 ...
 <div class="inline-flex items-center justify-center w-16 h-16 bg-gray-100 dark:bg-gray-900 rounded-full mb-4">
 ...
 <p class="text-gray-500 dark:text-gray-500 ">You're all caught up! No new notifications to show.</p>
 </div>
 @endforelse
 </div>
 </div>
