<x-app-layout>
 ...
 class="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-gray-100 :text-gray-200 transition-colors mb-4">
 <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
 </svg>
 Back to {{ $project->name }}
 </a>
 <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 ">{{ $workflow->name }}</h1>
 ...
 <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 ">Workflow Settings</h3>
 </div>
 <div class="p-6 space-y-4">
 <div class="flex items-center justify-between">
 <div>
 <div class="text-sm text-gray-700 dark:text-gray-300 ">Status</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 ">Active or inactive</div>
 </div>
 @if($workflow->is_active)
 <span class="px-3 py-1 bg-green-100 dark:bg-green-900 text-green-700 rounded-full text-sm font-medium">Active</span>
 @else
 <span class="px-3 py-1 bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 rounded-full text-sm font-medium">Inactive</span>
 @endif
 </div>
 <div class="flex items-center justify-between">
 <div>
 ...
 <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
 <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 ">
 <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 ">Workflow Steps</h3>
 </div>
 <div class="p-6">
 ...
 <span class="text-lg font-semibold text-blue-600 dark:text-blue-400 ">{{ $step['order'] }}</span>
 </div>
 <div class="flex-1">
 <div class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">
 Step {{ $step['order'] }}
 @if($step['parallel'] ?? false)
 <span class="ml-2 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded-full">Parallel</span>
 @endif
 </div>
 <div class="text-xs text-gray-500 dark:text-gray-500 ">
 Approvers:
 ...
 <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
 <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 ">
 <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 ">Active Approvals</h3>
 </div>
 <div class="p-6">
 ...
 <span class="px-2 py-1 text-xs bg-yellow-100 dark:bg-yellow-900 text-yellow-700 rounded-full">Pending</span>
 @elseif($approval->status === 'approved')
 <span class="px-2 py-1 text-xs bg-green-100 dark:bg-green-900 text-green-700 rounded-full">Approved</span>
 @elseif($approval->status === 'rejected')
 <span class="px-2 py-1 text-xs bg-red-100 dark:bg-red-900 text-red-700 rounded-full">Rejected</span>
 @elseif($approval->status === 'changes_requested')
 <span class="px-2 py-1 text-xs bg-orange-100 text-orange-700 rounded-full">Changes Requested</span>
 @endif
 </div>
 </div>
 @endforeach
 ...
 <div class="text-sm font-semibold text-gray-900 dark:text-gray-100 ">{{ $workflow->getTotalSteps() }}</div>
 </div>
 <div class="flex items-center justify-between">
 <div class="text-sm text-gray-700 dark:text-gray-300 ">Active Approvals</div>
 <div class="text-sm font-semibold text-gray-900 dark:text-gray-100 ">{{ $workflow->approvals->count() }}</div>
 </div>
 <div class="flex items-center justify-between">
 <div class="text-sm text-gray-700 dark:text-gray-300 ">Created At</div>
 <div class="text-sm text-gray-500 dark:text-gray-500 ">{{ $workflow->created_at->format('M d, Y') }}</div>
 </div>
 </div>
 </div>
 </div>
