<x-app-layout>
 ...
 class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 "
 ...
 <button type="button" 
 class="template-btn p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 :border-blue-400 transition-colors text-left"
 data-template="single">
 <div class="font-semibold text-gray-900 dark:text-gray-100 ">Single Approver</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 mt-1">Direct manager approves</div>
 </button>
 <button type="button" 
 class="template-btn p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 :border-blue-400 transition-colors text-left"
 data-template="sequential">
 <div class="font-semibold text-gray-900 dark:text-gray-100 ">Sequential Chain</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 mt-1">Designer → Manager → Client</div>
 </button>
 <button type="button" 
 class="template-btn p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 :border-blue-400 transition-colors text-left"
 data-template="parallel">
 <div class="font-semibold text-gray-900 dark:text-gray-100 ">Parallel Review</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 mt-1">Multiple reviewers simultaneously</div>
 </button>
 </div>
 </div>
 ...
 <div class="space-y-3">
 <div>
 <div class="text-xs text-gray-500 dark:text-gray-500 mb-1">Project Collaborators</div>
 <select id="approvers-select" multiple
 class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 h-32">
 ...
 <div>
 <div class="text-xs text-gray-500 dark:text-gray-500 mb-1">Workspace Members</div>
 ...
 <div class="text-center text-gray-500 dark:text-gray-500 py-4">
 ...
 <!-- Approval Settings -->
 <div class="space-y-4">
 <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100 ">Approval Settings</h4>
 
 <!-- Auto-route to next approver -->
 <div class="flex items-center justify-between">
 <div>
 <div class="text-sm text-gray-700 dark:text-gray-300 ">Auto-route to next approver</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 ">Automatically route to next when current approves</div>
 </div>
 ...
 <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 :ring-blue-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white dark:bg-gray-800 after:border-gray-300 dark:border-gray-600 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
 </label>
 </div>
 ...
 <div class="text-xs text-gray-500 dark:text-gray-500 ">Approvers must add comments when deciding</div>
 </div>
 <label class="relative inline-flex items-center cursor-pointer">
 ...
 <div class="text-xs text-gray-500 dark:text-gray-500 ">Reviewers can reject assets</div>
 </div>
 <label class="relative inline-flex items-center cursor-pointer">
 ...
 class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-700 :bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors">
 Cancel
 </a>
 </div>
 </div>
 ...
 <div class="text-center text-gray-500 dark:text-gray-500 py-8">
 ...
 selectedBtn.classList.add('border-blue-500', '', 'bg-blue-50', '/20');
 }
 ...
 if (approver) {
 html += `
 <div class="flex items-center space-x-3 bg-gray-50 dark:bg-gray-700 p-3 rounded-lg cursor-move hover:bg-gray-100 dark:bg-gray-900 :bg-gray-600 transition-colors"
 draggable="true"
 data-index="${index}"
 data-id="${approverId}">
 <div class="flex-shrink-0 w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 font-semibold">
 ${index + 1}
 </div>
 <div class="flex-1">
 <div class="text-sm font-medium text-gray-900 dark:text-gray-100 ">${approver.name}</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 ">Approves ${index === 0 ? 'first' : (index === sequentialOrder.length - 1 ? 'last' : 'after #' + index)}</div>
 </div>
 <button type="button" onclick="removeFromSequence(${index})" 
 class="text-gray-400 dark:text-gray-400 hover:text-red-500 transition-colors">
 ...
 <div class="font-medium text-gray-900 dark:text-gray-100 ">${selectedApprovers[0].name}</div>
 <div class="text-sm text-gray-500 dark:text-gray-500 ">Approver</div>
 </div>
 </div>
 `;
 break;
 ...
 <div class="text-sm font-medium text-gray-900 dark:text-gray-100 ">${approver.name}</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 ">Step ${index + 1}</div>
 </div>
 ...
 <div class="text-sm font-medium text-gray-900 dark:text-gray-100 ">${approver.name}</div>
 <div class="text-xs text-gray-500 dark:text-gray-500 ">Parallel Reviewer</div>
 </div>
 `).join('')}
 </div>
 `;
